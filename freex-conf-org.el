...
(add-to-list 'load-path "/home/azazel/.emacs.d/azazel/freex")
...
(eval-after-load "pymacs"
  '(add-to-list 'pymacs-load-path "/home/azazel/.emacs.d/azazel/freex")) ;; xxx

;; Specify where the freex .db file and its .freex (or .muse) friends
;; will live.  (Make sure this directory exists.)
(setq freex-mode-dir "/home/azazel/.emacs.d/azazel/freex/notes-org/") ; xxx

;; Set the file extension that identifies freex files
(setq freex-mode-ext "org")
...
(setq freex-mode-dir-filter "^[^.#]+\\.org$")
...
;; Org (XXX): To use Freex with Org, comment out the above
;; auto-mode-alist entry and uncomment the following
(defun org-freex-mode ()
...
(load "/home/azazel/.emacs.d/azazel/freex/freex-mode.el") ; xxx
